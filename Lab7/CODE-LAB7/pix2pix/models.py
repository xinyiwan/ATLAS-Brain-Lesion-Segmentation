...
from tensorflow.keras.layers import Flatten, Dense, Dropout, Activation, Lambda, Reshape
from tensorflow.keras.layers import Conv2D, Conv2DTranspose, ZeroPadding2D, UpSampling2D
...
def load_model(model_name, img_dim, nb_patch, bn_mode, use_mbd, batch_size, do_plot):
